package com.myk.learning.mybatis.ehcache.config;
 ...
 */
@Configuration
@MapperScan(basemyks = {"com.myk.learning.mybatis.ehcache.mapper"}, sqlSessionFactoryRef = "openPlatFormSqlSessionFactory")
